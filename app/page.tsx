                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <div className="flex flex-col items-center justify-center py-10 px-4">
                            ...
                            <p className="text-gray-700 leading-6 mt-12 mb-10 font-medium text-[20px] select-none">
                            ...
                            <ul className="mt-4 flex items-center justify-center space-x-6 md:space-x-4">
                                <li>
                                    <a
