                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <div className="flex flex-col items-center justify-center py-10 px-4">
                            ...
                            <p className="text-gray-400 leading-4 mt-10 mb-10 font-medium font-edu text-lg select-none">
                            ...
                            <ul className="flex space-x-4">
                                <li>
                                    <a
                                        ...
                                        <span className="ml-2">@wissen.creativo</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a
                                        ...
                                        <span className="ml-2">+57 315 4707281</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
