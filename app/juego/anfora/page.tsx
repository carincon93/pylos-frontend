    ...
    return (
        <div className={`fondo-anfora  ${showMenu ? 'md:bg-[150px] lg:bg-[315px] 2xl:bg-[335px_-240px]' : ''}`}>
            ...
            <div
                ...
                {warning && (
                    <div className="fixed bg-white/90 left-0 right-0 !bottom-32 w-[350px] p-2 rounded-full z-10 size-10 mx-auto text-center text-black flex items-center justify-center">
                        <svg
                        ...
                        Advertencia: ¡Ups! FPS bajo ({fps.toFixed(2)})
                    </div>
                )}
                ...
                {showMenu && (
                    <div className="fixed inset-0 bg-white md:w-[45vw] 2xl:w-[25vw] flex flex-col items-center justify-center px-16">
                        <div className="flex">
