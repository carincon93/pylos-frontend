                ...
                {showMenu && (
                    <div className="fixed inset-0 bg-white w-[25vw] flex flex-col items-center justify-center px-20">
                        ...
                        <p className="text-gray-400 leading-4 mt-4 mb-20 font-medium font-edu text-lg">
                            Producto de Wissen Creativo, donde la educación se encuentra con la tecnología, ofrecemos soluciones interactivas y gamificadas que transforman el aprendizaje en una
