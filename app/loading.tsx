...
export default function LoadingOverlay({ className }: Props) {
    ...
    return (
        <>
            <div className={`${className ? className : ''} bg-pylos-900 fixed left-0 top-0 right-0 w-full h-[100vh] z-[9999] text-white flex items-center justify-center text-4xl font-bold`}>
                <div className="mr-2">
                    PYLOS <span className="font-light">|</span>{' '}
                </div>
                <div className="word-wrapper font-edu">
