...
export function Isotipo({ className }: IsotipoProps) {
    return (
        <>
            <svg id="Layer_2" data-name="Layer 2" className={className} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 313.8 281.07" fill="currentColor">
                <defs>
                    <radialGradient id="radial-gradient" cx="-39.52" cy="-100.41" fx="-39.52" fy="-100.41" r="413.68" gradientUnits="userSpaceOnUse">
                        <stop offset=".39" stopColor="#ea93bb" />
                        <stop offset="1" stopColor="#9358a4" />
                    </radialGradient>
                    <radialGradient id="radial-gradient-2" r="413.68" xlinkHref="#radial-gradient" />
                </defs>
                <g id="Layer_1-2" data-name="Layer 1">
                    <g>
                        <path
                            ...
                            style={{ fill: 'url(#radial-gradient)', strokeWidth: '0px' }}
                        />
                        <circle cx="297.5" cy="59.58" r="15.2" style={{ fill: 'url(#radial-gradient-2)', strokeWidth: '0px' }} />
                    </g>
                </g>
            </svg>
        </>
