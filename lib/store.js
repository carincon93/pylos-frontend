...
export const useGameStore = create(
    subscribeWithSelector((set, get) => ({
        ...
        characterState: 'Idle',
        characterPosition: [0, 0, 0], // Inicializar la posición del personaje
